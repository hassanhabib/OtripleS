...
namespace OtripleS.Web.Api.Controllers
{
    ...
    public class CoursesController : RESTFulController
    {
        ...
        [HttpPost]
        public async ValueTask<ActionResult<Course>> PostStudentAsync(Course course)
        {
            try
            {
        ...
        [HttpGet]
        public ActionResult<IQueryable<Course>> GetAllStudents()
        {
            try
            {
                IQueryable<Course> storageCourses =
                    this.courseService.RetrieveAllCourses();

                return Ok(storageCourses);
            }
            catch (CourseDependencyException courseDependencyException)
            {
                return Problem(courseDependencyException.Message);
        ...
        [HttpGet("{courseId}")]
        public async ValueTask<ActionResult<Course>> GetStudentAsync(Guid courseId)
        {
            try
            {
