...
namespace OtripleS.Web.Api.Tests.Unit.Services.Registrations
{
    public partial class RegistrationServiceTests
    {
        ...
        [Fact]
        public async Task ShouldThrowValidationOnModifyIfDbUpdateConcurrencyExceptionOccursAndLogItAsync()
        {
            // given
            DateTimeOffset randomDateTime = GetRandomDateTime();
            DateTimeOffset dateTime = randomDateTime;
            ...
            var registrationValidationException =
                new RegistrationValidationException(lockedRegistrationException);
