...
namespace OtripleS.Web.Api.Tests.Unit.Services.Foundations.AssignmentAttachments
{
    public partial class AssignmentAttachmentServiceTests
    {
        ...
        public void ShouldThrowDependencyExceptionOnRetrieveAllAssignmentAttachmentsWhenSqlExceptionOccursAndLogIt()
        {
            ...
            // when
            ValueTask<AssignmentAttachment> retrieveallAssignmentAttachmentTask =
                this.assignmentAttachmentService.RetrieveAllAssignmentAttachment();

            // then
            await Assert.ThrowsAsync<AssignmentAttachmentDependencyException>(() =>
                retrieveallAssignmentAttachmentTask.AsTask());
