...
namespace OtripleS.Web.Api.Tests.Unit.Services.AssignmentServiceTests
{
    public partial class AssignmentServiceTests
    {
        ...
        [Fact]
        public async void ShouldThrowValidationExceptionOnCreateWhenDeadlineIsNotLaterThanCreatedDateAndLogItAsync()
        {
            // given
            DateTimeOffset dateTime = GetRandomDateTime();
            Assignment randomAssignment = CreateRandomAssignment(dateTime);
            Assignment inputAssignment = randomAssignment;
            inputAssignment.UpdatedBy = randomAssignment.CreatedBy;
            inputAssignment.Deadline = dateTime.AddDays(GetNegativeRandomNumber());
